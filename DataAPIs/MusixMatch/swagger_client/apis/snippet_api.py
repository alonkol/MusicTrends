...
class SnippetApi(object):
    ...
    def track_snippet_get_get(self, track_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.track_snippet_get_get(track_id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.track_snippet_get_get_with_http_info(track_id, **kwargs)
        else:
            (data) = self.track_snippet_get_get_with_http_info(track_id, **kwargs)
            return data

    def track_snippet_get_get_with_http_info(self, track_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.track_snippet_get_get_with_http_info(track_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method track_snippet_get_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'track_id' is set
        if ('track_id' not in params) or (params['track_id'] is None):
            raise ValueError("Missing the required parameter `track_id` when calling `track_snippet_get_get`")

        resource_path = '/track.snippet.get'.replace('{format}', 'json')
        path_params = {}
